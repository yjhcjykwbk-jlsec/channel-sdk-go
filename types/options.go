...
const DefaultMediaSourceMaxDownloadBytes int64 = 100 * 1024 * 1024
...
// MediaSourceConfig controls local/URL media sources used for outbound uploads.
...
func DefaultChannelConfig() ChannelConfig {
	return ChannelConfig{
		...
		Outbound: OutboundConfig{
			...
			MediaSource: MediaSourceConfig{
				MaxDownloadBytes: DefaultMediaSourceMaxDownloadBytes,
			},
			Retry: struct {
				MaxAttempts int
				BaseDelayMs time.Duration
